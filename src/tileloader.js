//function fetch_tile(sql, callback) {
//        //d3.json('http://pluto.cartodb.com/api/v2/sql?q=' + encodeURIComponent(sql) + '&format=geojson', callback)
//        d3.json('http://dev.localhost.lan:8080/api/v1/sql?q=' + encodeURIComponent(sql) + '&format=geojson', callback)
//  };
//
//
//
...
//
//          fetch_tile(tileProvider('pluto', t.x, t.y, t.zoom), function(data) {
//            var tile = new Tile(data, self.renderer)
//            self._tileLoaded(t, tile);
//            self.redraw();
//            if (tile.triangleCount) {
//              console.log("tri", self.triangleCount += tile.triangleCount);
//            }
//          });
//        });
