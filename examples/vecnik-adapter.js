...
function addVecnikLayer(options, columns) {
...
console.log(layerOptions.cartocss);
  var shader = new VECNIK.CartoShader(layerOptions.cartocss);
...
function initVecnikAdapter(containerId, vizUrl, refMap, columns) {
...
//      }
      ...
      if (layer.type === 'layergroup') {
        addVecnikLayer(layer.options, columns).addTo(map);
      }
    }
